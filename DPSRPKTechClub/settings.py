"""
Django settings for DPSRPKTechClub project.
...
SECRET_KEY = 'updgm)#-($4i@opn4mxavfk560^_xy7f%q0u%43r9x-@v0w(ws'
...
ROOT_URLCONF = 'DPSRPKTechClub.urls'
...
WSGI_APPLICATION = 'DPSRPKTechClub.wsgi.application'
ASGI_APPLICATION = 'DPSRPKTechClub.routing.application'
CHANNEL_LAYERS = {
    'default': {
...
DATABASES = {
    'default': {
        ...
        'NAME': Hide.DATABASE_NAME,
        'USER': Hide.DATABASE_USER,
        'PASSWORD': Hide.DATABASE_PASS,
        'HOST': 'localhost',
        'PORT': '',
    }
}
